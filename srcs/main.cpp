...
/*   Updated: 2017/10/26 01:17:23 by amineau          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
	...
	// Move &	moves = pieces[1][3]->getMoving(pieces, 0);
	...
	// board.moving(moves.getDestination(4, 2));	

	Move & moves = pieces[0][1]->getMoving(pieces, 0);
	...
	moves = pieces[6][2]->getMoving(pieces, 0);
	std::cout << moves <<std::endl;
