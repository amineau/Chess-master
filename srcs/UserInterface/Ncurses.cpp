...
short Ncurses::displayMenu() const
{
	// char entry = 0;
...
void Ncurses::setSelectedSpot(Spot* spot)
{
...
void Ncurses::setOveredSpot(Spot* spot)
{
	if (this->_overedSpot) {
...
void Ncurses::setDestinationSpots(std::vector<Spot*> spots)
{
...
void Ncurses::printSpot(const short x, const short y, const short colorPair, const char* piece = " ") const
{
...
void Ncurses::displaySpot(const Spot* spot, unsigned int spotColor) const
{
...
void Ncurses::displayBoard(const Chess& chess) const
{
	for (short x = 0; x < 8; x++)
		for (short y = 0; y < 8; y++)
...
void Ncurses::displayNewMove(const Move& move, const short moveCounter) const
{
